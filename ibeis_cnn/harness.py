...
def test_convolutional(net, theano_predict, image, patch_size='auto',
    ...
    Args:
        net (network): the network to use to perform feedforward inference
    ...
    result_list = utils.extract_patches_stride(image, patch_size, stride)
    data_list, coord_list = result_list
