...
class SiameseCenterSurroundModel(abstract_models.BaseModel):
    ...
    def initialize_architecture(model, verbose=True, **kwargs):
        ...
        CommandLine:
            ...
            python -m ibeis_cnn.models --test-SiameseCenterSurroundModel.initialize_architecture --verbcnn --show
...
@six.add_metaclass(ut.ReloadingMetaclass)
class SiameseL2(abstract_models.BaseModel):
    """
    Model for individual identification
    ...
    def initialize_architecture(model, verbose=True, **kwargs):
        ...
        CommandLine:
            python -m ibeis_cnn.models --test-SiameseL2.initialize_architecture --verbcnn --show
        ...
        network_layers_def = model.get_siam2stream_l2_def(verbose=verbose, **kwargs)
        # connect and record layers
        network_layers = abstract_models.evaluate_layer_list(network_layers_def)
        #model.network_layers = network_layers
        output_layer = network_layers[-1]
