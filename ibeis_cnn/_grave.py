...
OLD COMMAND LINE:
    ...
    TestingCommandLine:
        ...
        python -m ibeis_cnn.train --test-train_patchmatch_pz --db PZ_MTEST --weights=pzmaster --test --checkpoint master21
        ...
        python -m ibeis_cnn.train --test-train_patchmatch_pz --db nnp3-2 --arch=siaml2 --weights=new  --train
        python -m ibeis_cnn.train --test-train_patchmatch_pz --db NNP_Master3 --num_top=None --arch=siaml2 --weights=current  --test
